...
<!-- Animated Header -->
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=Hey,%20I'm%20Steven%20Wang%20👋&fontSize=42&fontColor=fff&animation=twinkling&fontAlignY=32"/>
...
class Steven:
    def __init__(self):
        self.role = "Full-Stack Data Enthusiast"
        self.domains = [
            "MLE", "AIE", "MLOps", "DS", "DE", "DA"
        ]
        self.superpowers = [
            "turning data into gold", 
            "training models at 1am", 
            "deploying systems at 3am"
        ]
        self.caffeine_dependency = float('inf')
        self.bugs_squashed = 1e10 # lost count
    ...
    def philosophy(self):
        return "If it's not in production, it doesn't exist."
```

I live where **raw data** meets **deployed models** — turning bytes into intelligence and shipping it to prod.

I don't just *use* AI — I **build it, finetune it, optimize it, and deploy it**. From training loops to inference endpoints, I do the full stack.

I also fully embrace the **vibe coding** era. Why fight the AI when you can vibe with it?
...
![OpenAI](https://img.shields.io/badge/OpenAI-74AA9C?style=for-the-badge&logo=chromatic&logoColor=white)
...
![AliCloud](https://img.shields.io/badge/Ali_Cloud-FF6A00?style=for-the-badge)
![TencentCloud](https://img.shields.io/badge/Tencent_Cloud-00A4FF?style=for-the-badge)
...
![Profile Views](https://komarev.com/ghpvc/?username=stevenuuang&color=blueviolet&style=for-the-badge)

*May your models converge and your pipelines never break* ✨
